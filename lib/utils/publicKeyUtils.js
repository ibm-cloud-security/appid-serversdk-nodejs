...
const PUBLIC_KEY_PATH = "/authorization/v1/apps/{tenantId}/publickey";
...
module.exports = (function(){
	...
	function retrievePublicKey(tenantId, serverUrl){
		var serverUrl = (serverUrl + PUBLIC_KEY_PATH).replace("{tenantId}", tenantId);

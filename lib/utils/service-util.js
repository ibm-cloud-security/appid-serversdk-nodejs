        ...
        request({headers: {'Accept': 'application/json'}, url: discoveryEndpoint}, (error, response, body) => {
            if (error) {
                ...
                if (response.statusCode === 200) {
                    ...
                    serviceVersion = getVersionFromDiscoveryEndpoint(discoveryEndpoint);
                } else {
...
const getVersionFromDiscoveryEndpoint = discoveryEndpoint => {
    const tenantIndex = discoveryEndpoint.findIndex(serviceTenantID);

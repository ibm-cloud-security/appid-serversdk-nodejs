...
module.exports = (function () {
	...
	function decodeAndValidate(tokenString) {
		var deferred = Q.defer();
                ...
                var localPublicKeyEndpoint;
                if (arguments.length > 1) {
                       localPublicKeyEndpoint = arguments[1];
                } else {
                       localPublicKeyEndpoint = publicKeyUtil.getPublicKeysEndpoint();
                }
		...
		publicKeyUtil.getPublicKeyPemByKid(tokenHeader.kid, localPublicKeyEndpoint).then(function (publicKeyPem) {
			try {

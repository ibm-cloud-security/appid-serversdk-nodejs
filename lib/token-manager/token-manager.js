...
function getTokens(tokenEndpoint, clientId, secret, grantType, scope, assertion) {
...
TokenManager.prototype.getCustomIdentityTokens = function getCustomIdentityTokens(jwsToken, scopes = []) {
...
TokenManager.prototype.getApplicationIdentityToken = function getApplicationIdentityToken() {
  const clientId = this.serviceConfig.getClientId();
  const secret = this.serviceConfig.getSecret();
  const tokenEndPoint = this.serviceConfig.getOAuthServerUrl() + constants.TOKEN_PATH;

 ...
 *	webAppStrategy.logoutSSO(req,res, { callback: "http://localhost:3000/niceGoodbyePage" , all_sessions: false });
 * });
 * @param req - the HTTP request
 * @param res - the HTTP response object (will be used to redirect)
 * @param options - need to contain at least the  callback. all_sessions can logout all the users sessions at once.
 */

...
function finishLogout(req, options, done) {
...
WebAppStrategy.logout = function (req, options, done) {
	finishLogout(req, options, done);
};

// preferred non-static version, logs event to the auth server
WebAppStrategy.prototype.logout = function (req, options, done) {

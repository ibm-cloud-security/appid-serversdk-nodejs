...
Bare in mind, while audience is optional, it is highly recommended to have some value in it.
Non empty audience will allow fine grained access control and will guarantee that only this application can access the remote resource. 
It simply adds another level of security.
